...
?><div class="padding-0">
    <div class="cp-item">
        ...
        <div class="row cp-info">
            ...
            <div class="col-xl-7 col-xs-7 col-md-7 col-md-7 col-lg-7 cp-r-info centered">
                    @if($c['verified'])<span class="top-verified"><i class="fa fa-check"></i> Verified</span>@endif
                ...
                <div class="cp-menu">
			<span class="expr">Expires {{date('d M Y h:i a',strtotime($c['expire_date']))}}</span>
                </div>
					@endif
            </div>
