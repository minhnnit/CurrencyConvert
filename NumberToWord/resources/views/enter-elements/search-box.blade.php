<input type="text" class="form-control input-s-top search-form-header" placeholder="Find your favorite stores, brand & categories">
<div class="input-group-append">
    <span class="input-group-text input-s-top-append"><em class="fa fa-search fa-lg"></em></span>
</div>
