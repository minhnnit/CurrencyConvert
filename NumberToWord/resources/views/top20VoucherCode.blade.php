    ...
    <div class="container">
        <ol class="cd-breadcrumb custom-separator" itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            <li class="current" itemprop="itemListElement" itemscope
                itemtype="http://schema.org/ListItem">
                <em itemprop="name">Best {{config('config.Coupon')}}</em>
    ...
    <div class="list-top-voucher-items">
        <div class="container" >
            <div class="row top-voucher-lsi-items">
                <h1 class="lsi-header"><span><img src="{{asset('images/top-20-voucher.png') }}" /> &nbsp; Best {{config('config.Coupon')}}</span></h1>
                <div class="lsi-items" >
                    <!-- Box-top-stores -->
                    <div class="col-lg-6 col-md-8 hidden-sxs box-mdi-item">
                        <div class="box-top-stores">
                            <div class="lsi-top-stores" >
                                ...
                                <div class="box-stores-desc">Enjoy special savings at the best stores of {{config('config.domain')}}!</div>
                            </div>
